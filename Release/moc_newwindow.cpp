...
QT_MOC_LITERAL(3, 23, 9) // "renderNow"
    ...
    "NewWindow\0renderLater\0\0renderNow"
};
...
const QMetaObject NewWindow::staticMetaObject = {
    { &QWindow::staticMetaObject, qt_meta_stringdata_NewWindow.data,
...
void *NewWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< NewWindow*>(this));
